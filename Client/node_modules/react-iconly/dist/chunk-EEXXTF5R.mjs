...
var Download = ({ color, secondaryColor, strokeWidth, opacity, set }) => {
  const Bold = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(2 2.5)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Bulk = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(2 2.5)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
