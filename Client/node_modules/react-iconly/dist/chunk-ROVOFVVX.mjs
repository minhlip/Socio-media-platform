...
var CallSilent = ({ color, secondaryColor, strokeWidth, opacity, set }) => {
  const Bold = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(2 1.5)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Bulk = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(2 1.5)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
