...
var Swap = ({ color, secondaryColor, strokeWidth, opacity, set }) => {
  ...
  const Broken = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(2.5 3)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Curved = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(2.9 4.6)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
      d: "M.5,0V12.618",
