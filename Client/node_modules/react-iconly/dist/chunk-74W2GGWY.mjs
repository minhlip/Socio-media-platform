...
var ChevronRight = ({ color, secondaryColor, strokeWidth, opacity, set }) => {
  const Bold = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(7 6)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Bulk = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(7 18) rotate(-90)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Light = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(8.5 19) rotate(-90)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
      d: "M14,0,7,7,0,0",
      fill: "none",
  ...
  const Broken = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(7.5 4)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Curved = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(8.5 19) rotate(-90)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
