...
var ChevronDown = ({ color, secondaryColor, strokeWidth, opacity, set }) => {
  const Bold = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(6 7)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Bulk = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(6 7)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Light = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(5 8.5)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
      d: "M14,0,7,7,0,0",
      fill: "none",
  ...
  const Broken = () => /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Curved = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(5 8.5)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
