...
var Bookmark = ({ color, opacity, secondaryColor, strokeWidth, set }) => {
  const Bold = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(4 2)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Bulk = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(4 2)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
