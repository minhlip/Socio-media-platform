...
var Message = ({ color, secondaryColor, strokeWidth, opacity, set }) => {
  ...
  const Bulk = () => /* @__PURE__ */ React.createElement("g", null, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Light = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(2 3.5)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Curved = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(2.452 2.852)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
