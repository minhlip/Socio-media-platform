...
var Location = ({ color, secondaryColor, strokeWidth, opacity, set }) => {
  ...
  const Bulk = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(5 2)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  const Curved = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(4.5 3)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
