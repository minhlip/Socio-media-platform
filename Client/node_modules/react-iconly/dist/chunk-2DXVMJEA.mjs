...
var Voice = ({ color, secondaryColor, strokeWidth, opacity, set }) => {
  ...
  const TwoTone = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(4 2)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
      d: "M0,0A7.4,7.4,0,1,0,14.808,0",
      transform: "translate(0.714 8.932)",
  ...
  const Curved = () => /* @__PURE__ */ React.createElement("g", { transform: "translate(4.9 2.5)" }, /* @__PURE__ */ React.createElement(
    "path",
    {
